...
namespace sora{
    ...
    void SoraiOSGLRenderer::renderLine(float x1, float y1, float x2, float y2, uint32 color, float z) {
		sora::SoraQuad quad;
	...
	void SoraiOSGLRenderer::renderBox(float x1, float y1, float x2, float y2, uint32 color, float z) {
