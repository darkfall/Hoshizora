...
//		if(!windowInfo->isWindowSubWindow()) {
    ...
    void SoraHGERenderer::renderLine(float32 x1, float32 y1, float32 x2, float32 y2, uint32 color, float32 z) {
		sora::SoraQuad quad;
    ...
    void SoraHGERenderer::fillBox(float32 x1, float32 y1, float32 x2, float32 y2, uint32 color, float32 z) {
        sora::SoraQuad quad;
