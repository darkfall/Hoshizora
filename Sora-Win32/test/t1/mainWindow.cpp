...
void mainWindow::init() {
	mu = sora::SoraCore::Ptr->createMusicFile(L"Kalimba.mp3", true);
	if(mu)
		mu->play();
 ...
 //   mScene1->enableRenderToCanvas(true);
    ...
    mScene1->add(mScene2);
    sora::SoraSprite* bg = sora::SoraCore::Ptr->createSprite(L"bg_optd.png");
    mScene1->add(bg, 0);
    
    sora::SoraSprite* spr = sora::SoraCore::Ptr->createSprite(L"bullet2.png");
 ...
 //   mScene2->setScale(2.f, 2.f);
    ...
    mScene3->add(sora::SoraCore::Ptr->createSprite(L"boxbutton.png"));
    mScene2->add(mScene3);
